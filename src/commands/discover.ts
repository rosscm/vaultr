...
function shouldRunWeeklyDiscoverySourceTopOff(readiness: WeeklyDiscoverySupplyReadiness): boolean {
  return readiness.shouldTopOff && !weeklyDiscoveryLocalSupplySufficientForMarketRecovery(readiness);
}
